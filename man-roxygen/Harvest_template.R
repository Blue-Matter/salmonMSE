...
#' @slot u_preterminal Numeric, matrix `[nsim, proyears]`, or function. If `type_PT = "u"`, the harvest rate of the immature component of the population in the pre-terminal fishery.
#' The harvest rate is the ratio to kept AEQ catch to (kept AEQ catch + return), where AEQ are adult equivalents. Function should be of the form `function(NO, HO, m) return(u)`.
#' @slot u_terminal Numeric, matrix `[nsim, proyears]`, or function. If `type_T = "u"`, the harvest rate (ratio of kept catch to return) of the terminal marine fishery.
#' @slot K_PT Numeric or function. If `type_PT = "catch"`, the catch target of the immature component of the population in the pre-terminal fishery. Function should be of the form `function(NO, HO, m) return(u)`.
