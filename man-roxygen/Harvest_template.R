...
#' @slot u_preterminal Numeric. If `type_PT = "u"`, the exploitation rate of the immature stock in the pre-terminal fishery.
#' @slot u_terminal Numeric. If `type_T = "u"`, The exploitation rate of the return in the terminal fishery.
