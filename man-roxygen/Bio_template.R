...
#' @slot a Vector length `nsim`. The alpha parameter of the Ricker stock-recruit function.
#' @slot Smax Vector length `nsim`. The Smax parameter of the Ricker stock-recruit function.
