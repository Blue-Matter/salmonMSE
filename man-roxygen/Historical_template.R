...
#' @slot HistSpawner_HOS Array by `[nsim, maxage, nyears]`. Hatchery origin spawners at age in the natural environment. *Optional*
...
#' @slot HistNjuv_HOS Array by `[nsim, maxage, nyears+1]`. The abundance of immature hatchery origin fish at the beginning of the annual time step.
#' Default assumes 1000 smolts (age-1) fish annually.
