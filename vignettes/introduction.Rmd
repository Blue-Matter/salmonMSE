...
Currently, the operating model is intended to be used for species where all fish mature at a single age and operates on a generational cycle, analogous to AHA.
Stochasticity is incorporated in the stock-recruit relationship, which predicts density-dependent smolt production from fry, and in the SAR parameter (survival to adult return).
