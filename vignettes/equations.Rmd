...
The first consideration is to specify the target number of annual releases of sub-yearlings $n^\textrm{subyearling}$ and yearlings $n^\textrm{yearling}$. 
...
The proportion $p^\textrm{broodtake}$ is solved annually to satisfy the following conditions:
...
\begin{align}
\textrm{Smolt}^\textrm{NOS}_{y+1} &= \frac{\alpha^{\prime\prime} (W^\textrm{nat.}_{y+1})^{\ell_\textrm{fry}} \times 
\textrm{Fry}^\textrm{NOS}_y}{1 + \beta^{\prime\prime} (\textrm{Fry}^\textrm{NOS}_y + \textrm{Fry}^\textrm{HOS}_y)}\\
\textrm{Smolt}^\textrm{HOS}_{y+1} &= \frac{\alpha^{\prime\prime}  (W^\textrm{nat.}_{y+1})^{\ell_\textrm{fry}} \times 
\textrm{Fry}^\textrm{HOS}_y}{1 + \beta^{\prime\prime} (\textrm{Fry}^\textrm{NOS}_y + \textrm{Fry}^\textrm{HOS}_y)}
\end{align}
...
>
>\begin{align}
>\textrm{Smolt}^\textrm{NOS}_{y+1} &= \alpha^{\prime\prime} (W^\textrm{nat.}_{y+1})^{\ell_\textrm{fry}} \times 
>\textrm{Fry}^\textrm{NOS}_y \times \exp(-\beta^{\prime\prime} [\textrm{Fry}^\textrm{NOS}_y + \textrm{Fry}^\textrm{HOS}_y])\\
>\textrm{Smolt}^\textrm{HOS}_{y+1} &= \alpha^{\prime\prime} (W^\textrm{nat.}_{y+1})^{\ell_\textrm{fry}} \times 
>\textrm{Fry}^\textrm{HOS}_y \times \exp(-\beta^{\prime\prime} [\textrm{Fry}^\textrm{NOS}_y + \textrm{Fry}^\textrm{HOS}_y])
>\end{align}
>
