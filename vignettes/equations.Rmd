...
knitr::kable(param[grepl("Natural production|Population dynamics", param$Type), ])
```

## Habitat

```{r param-habitat, echo = FALSE}
knitr::kable(param[grepl("Habitat", param$Type), ])
```

## Hatchery

```{r param-hatchery, echo = FALSE}
knitr::kable(param[grepl("Hatchery|Fitness", param$Type), ])
```

## Harvest

```{r param-harvest, echo = FALSE}
knitr::kable(param[grepl("Harvest", param$Type), ])
```
