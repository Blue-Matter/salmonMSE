...
The code below demonstrates how a full simulation design can be specified in a data frame, where each row specifies a specific set of conditions. 
The simulation is repeated for each row in the data in parallel using the `snowfall` R package to minimize computing time.
