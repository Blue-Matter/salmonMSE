...
The example here extends the [first example](../articles/example.html) of a salmon operating model that has a single brood year recruitment where all fish mature at age 3.
