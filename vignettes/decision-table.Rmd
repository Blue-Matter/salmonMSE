...
These four options are evaluated across three states of nature with respective to productivity: a mean compensation ratio of either 3, 6, or 9. We sample the compensation ratio (kappa) over 100 simulation with a lognormal standard deviation of 0.4.

There is no habitat enhancement, i.e., no changes to the smolt production function or time-varying survival, and a fixed harvest rate is applied at 0.50 in all scenarios. The decision-making context here assumes that the harvest rate is fixed.
