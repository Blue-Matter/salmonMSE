...
The following code demonstrates the setup for a multi-population model and builds off the [first example](../articles/example.html) to evaluate the influence of a nearby hatchery (population #1) on a small un-enhanced system (population #2).
