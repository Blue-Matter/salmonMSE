...
```{r SRR, fig.cap="Median stock-recruit relationship. Points show annual smolt production from egg production (medians), with numbers correspond to years of egg production."}
CM_SRR(report, year1)
```
