...
```{r SRR, fig.cap="Estimated stock-recruit relationship (medians and 95% prediction interval). Years correspond to years of egg production (assumes juvenile production for the following brood year). Points show annual smolt production (medians)."}
CM_SRR(report, year1)
```
