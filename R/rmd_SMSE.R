...
rmd_natural_production <- function(s, sname) {
  ...
  c(
    ...
    "```",
    "\n",
    "```{r, fig.cap=\"Smolt production (density-dependent stock-recruit relationship). The dotted vertical line denotes the median egg production at unfished replacement.\"}",
