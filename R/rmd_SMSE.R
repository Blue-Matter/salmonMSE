...
make_rmd_stock <- function(s, sname) {
  ...
  c(
    ...
    "#### Parameters",
    "\n",
    "```{r, fig.cap=\"Histogram of kappa (compensation ratio).\"}",
    "SOM <- SMSE@Misc$SOM",
    "plot_SOM(SOM, var = \"kappa\", xlab = \"Compensation ratio\")",
    "```",
    "\n",
    "```{r, fig.cap=\"Histogram of Smax (egg production that maximizes smolt production).\"}",
    "if (SOM@Bio@SRrel == \"Ricker\") plot_SOM(SOM, var = \"Smax\", xlab = expression(S[max]))",
    "```",
    "\n",
    "```{r, fig.cap=\"Histogram of smolt capacity (Beverton-Holt asymptote).\"}",
    "if (SOM@Bio@SRrel == \"BH\") plot_SOM(SOM, var = \"capacity_smolt\", xlab = \"Smolt capacity\")",
    "```",
    "\n",
    "#### Time series",
    "\n",
